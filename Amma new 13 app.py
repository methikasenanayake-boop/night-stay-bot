...
if sys_file and bkg_file:
    ...
    # 4. Normalize guest names (uppercase, trim)
    ...
    # 6. System nights count per guest
    sys_cnt = (
        df_sys
        .groupby("_GUEST")
        .size()
    ...
    # 7. Booking.com nights sum per guest
    ...
    # 9. Calculate differences and statuses
